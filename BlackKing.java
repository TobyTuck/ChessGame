...
public class BlackKing extends ChessPiece {
    ...
    public BlackKing(BufferedImage image, int location) {
    ...
    public List possibleMoves(int location, List chessboard, boolean considerCheck,
        ...
        if (considerCheck) {
            ...
            if (!hasMoved() && chessboard.getComponent(1) == null && chessboard.getComponent(2) == null
                    && chessboard.getComponent(3) == null && myRook1 instanceof BlackRook &&
            ...
            if (!hasMoved() && chessboard.getComponent(5) == null && chessboard.getComponent(6) == null
                    && myRook2 instanceof BlackRook && !check(location, chessboard)) {
     ...
     * NOTE: inputing the king's location will check if the piece is currently in
     * check
     */
    ...
    public String toString() {
        return "Black King: " + Integer.toString(_location);
    }
}
