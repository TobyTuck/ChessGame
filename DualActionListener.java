/*
This is an ActionListener for the Dual Player Game Mode button on the Settings Panel
*/
...
public class DualActionListener implements ActionListener {
    ...
    private BotActionListener _otherOption;

    public DualActionListener(int width, int height, JButton button, BoardMouseAdapter bma) {
        _bma = bma;
        _isSelected = false;
        _myButton = button;

        ImageIcon image1 = new ImageIcon("TwoPlayerSelected.png");
        ImageIcon image2 = new ImageIcon("TwoPlayerUnselected.png");
    ...
    public void addBotActionListener(BotActionListener otherOption) {
