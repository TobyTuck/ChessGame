/*
This is an ActionListener for the Log In button under the Account Settings
*/
...
public class LoginActionListener implements ActionListener {
    ...
    public LoginActionListener(JPanel background, JPanel p1, JPanel p2, JPanel p3, JPanel p4,
