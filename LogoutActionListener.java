/*
This is an ActionListener for the Log Out button under the Account Settings
*/
...
public class LogoutActionListener implements ActionListener {
    ...
    public LogoutActionListener(JPanel background, JPanel p1, JPanel p2, JPanel p3, JPanel p4,
    ...
    private void addComponents() {
        ...
        RegisterActionListener ral = new RegisterActionListener(_background, _panel1, _panel2, _panel3,
                _panel4, _panel5, _labelFont, _mediumPanelSize);
        button1.addActionListener(ral);
        ...
        LoginActionListener lal = new LoginActionListener(_background, _panel1, _panel2, _panel3,
                _panel4, _panel5, _labelFont, _mediumPanelSize);
